 ...
 */
var demographicsInfoBtn = L.easyButton( "fa-solid fa-info fa-beat-fade", function (btn, map) {
...
var breakingNewsWikipediaBtn = L.easyButton("fa-brands fa-wikipedia-w", function (btn, map) {
  ...
  */
  ...
  document.getElementById("convert").addEventListener('click', function() {
    ...
    if (amount && currency) {
      ...
      conversionResult.textContent = `${amount} ${currency} is approximately ${result.toFixed(2)} USD`;
    } else {
      conversionResult.textContent = 'Please enter an amount and select a currency';
    }
  })
